...
SELECT TD001,TD002,TD003,TD004,TD005,TD006,TD008
FROM JS..PURTD
INNER JOIN JS..PURTC ON TC001=TD001 AND TC002=TD002 WHERE TD016='N'

SELECT MB001,MB002,MB003,MB029
FROM JS..INVMB
WHERE MB029 != '' AND MB025 = 'M'
