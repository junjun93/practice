...
BEGIN
  ...
  IF @iCankaoNo IS NULL OR @iCankaoNo = ''
    ...
    SELECT TD012,TD021,TD004,* FROM (SELECT SUBSTRING(DS2010..PURTD.UDF01,1,4)+'-'+SUBSTRING(DS2010..PURTD.UDF01,5,2)+'-'+SUBSTRING(DS2010..PURTD.UDF01,7,2) AS UDF01,SUBSTRING(TD012,1,4)+'-'+SUBSTRING(TD012,5,2)+'-'+SUBSTRING(TD012,7,2) AS TD012,TD001+'-'+TD002+'-'+TD003 AS DOCNO,TD004,MB002,MB003,TD009,
